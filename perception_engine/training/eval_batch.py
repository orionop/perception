...
def main():
    ...
    parser.add_argument("--weights", default="weights/best_model_v6.pth")
    ...
    parser.add_argument("--histograms", default="weights/color_histograms.pkl")
    parser.add_argument("--eda-priors", default="weights/eda_priors.pkl")
    parser.add_argument("--joint-histograms", default="weights/joint_histograms.pkl")
